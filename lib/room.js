                            ...
                            user_controls_container.addEventListener('click', function(e) {
                                ...
                                switch(e.target.getAttribute('status-action')) {
                                    case 'mute':
                                        ...
                                        console.log('Muting ' + user_status.user_first_name);
                                        
                                        new_user_status = (user_status.user_status == 1) ? 0 : 1;

                                        break;
                                    case 'kick':

                                        console.log('Kicking ' + user_status.user_first_name);
                                        
                                        new_user_status = (user_status.user_status == 2) ? 0 : 2;

                                        break;
                                    case 'ban':

                                        console.log('Banning ' + user_status.user_first_name);
                                        
                                        new_user_status = (user_status.user_status == 2) ? 0 : 3;

                                        break;
                                }
                                
                                Ajax('PUT', '/room/' + room.room_id + '/userstatus', ['user_id=' + user_status.user_id, 'user_status=' + new_user_status], function(r, c) {
